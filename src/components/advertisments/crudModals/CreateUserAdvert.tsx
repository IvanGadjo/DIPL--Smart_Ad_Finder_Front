...
import { SaveAsIcon, TrashIcon, ReplyIcon, CheckIcon, SelectorIcon } from "@heroicons/react/outline";
...
const CreateUserAdvert: FC<{}> = () => {        
    ...
    const handleSubmit = async (e: React.SyntheticEvent) => {
        ...
        if(userId) {
            ...
            let newAd = await createUserAdvert(userAd, frmData, userId, auth0UserInfo.token);
            
            setAdverts([...allAdverts, newAd])      // * Update ads in swr hook for real time render of ads
    ...
    return (
        <>      
            ...
            <h1 className="text-2xl font-semibold text-gray-900 mb-7">Додади нов оглас:</h1>
...
export default CreateUserAdvert;   